...
function HeroMockup({ dark }: HeroMockupProps) {
  ...
  return (
    <div className="hero-mockup" style={{ 
      ...
      {/* Header */}
      <div className="hm-header" style={{ padding: "16px 24px", borderBottom: `1px solid ${border}`, display: "flex", alignItems: "center", justifyContent: "space-between" }}>
        <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
          <div style={{ color: "#8b5cf6" }}><Sparkles size={18} /></div>
          <span style={{ fontWeight: 600, fontSize: 14, color: text }}>Ask Mona</span>
          <span style={{ padding: "2px 8px", background: t(dark, "#2a2a2a", "#f3f4f6"), borderRadius: 6, fontSize: 11, fontWeight: 600, color: muted }}>Q&A Beta</span>
        </div>
        <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 6, color: "#8b5cf6", fontSize: 13, fontWeight: 500, cursor: "pointer" }}>
            <Check size={14} /> Save
          </div>
          <Link2 size={16} color={muted} style={{ cursor: "pointer" }} />
          <MoreHorizontal size={16} color={muted} style={{ cursor: "pointer" }} />
        </div>
      </div>
      ...
      <div className="hm-content" style={{ padding: "32px", minHeight: 400, position: "relative" }}>
        ...
        <div className="hm-input" style={{ 
          ...
          {/* Controls */}
          <div style={{ padding: "8px 16px", display: "flex", alignItems: "center", gap: 12, borderBottom: `1px solid ${t(dark, "#333", "#f0f0f0")}` }}>
             <div style={{ display: "flex", gap: 4 }}>
               <div style={{ width: 20, height: 20, background: t(dark, "#333", "#f3f4f6"), borderRadius: 4, display: "flex", alignItems: "center", justifyContent: "center", fontSize: 10 }}>▲</div>
               <div style={{ width: 20, height: 20, background: t(dark, "#333", "#f3f4f6"), borderRadius: 4, display: "flex", alignItems: "center", justifyContent: "center", fontSize: 10 }}>▼</div>
             </div>
             <span style={{ fontSize: 11, color: muted, fontWeight: 500 }}>to navigate</span>
             <div style={{ width: 20, height: 20, background: t(dark, "#333", "#f3f4f6"), borderRadius: 4, display: "flex", alignItems: "center", justifyContent: "center", fontSize: 10 }}>↩</div>
             <span style={{ fontSize: 11, color: muted, fontWeight: 500 }}>to select</span>
             <div style={{ marginLeft: "auto", display: "flex", gap: 6 }}>
               <span style={{ padding: "2px 6px", border: `1px solid ${t(dark, "#444", "#ddd")}`, borderRadius: 4, fontSize: 10, color: muted }}>esc</span>
               <span style={{ fontSize: 11, color: muted, fontWeight: 500 }}>to close</span>
             </div>
          </div>
