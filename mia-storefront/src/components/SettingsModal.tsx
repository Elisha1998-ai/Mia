            ...
            {filteredOptions.length > 0 ? (
              filteredOptions.map((option) => (
                <button
                  ...
                  className={`w-full text-left px-4 py-2.5 text-sm transition-colors ${value === option
            ...
            <div className="flex items-center justify-between p-4 md:p-5">
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  className="p-2 hover:bg-foreground/5 rounded-full transition-colors text-foreground/40 hover:text-foreground flex items-center gap-2"
              ...
              <div className="flex flex-col gap-1 w-full">
                {navItems.map((item) => (
                  <button
                    ...
                    className={`flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm transition-all ${activeTab === item.id
