...
class StoreSettings(Base):
    ...
    social_tiktok = Column(String, name='socialTiktok')
    social_youtube = Column(String, name='socialYoutube')
    social_snapchat = Column(String, name='socialSnapchat')
    currency = Column(String, default='Nigerian Naira (₦)')
    location = Column(String, default='Nigeria')
    ai_tone = Column(String, default='Professional & Helpful', name='aiTone')
    admin_name = Column(String, default='Jonathan Frazzelle', name='adminName')
    admin_email = Column(String, default='jon@mia-agents.ai', name='adminEmail')
    admin_role = Column(String, default='Store Owner', name='adminRole')
    sender_name = Column(String, default='Mia Store', name='senderName')
    sender_email = Column(String, name='senderEmail')
    store_logo = Column(String, name='storeLogo')
    ...
    button_radius = Column(String, default='0.5rem', name='buttonRadius')
...
class Product(Base):
    ...
    cost_of_goods = Column(DECIMAL(10, 2), name='costOfGoods') # New: Track margins
...
class Customer(Base):
    ...
    phone = Column(String)
    lifetime_value = Column(DECIMAL(10, 2), default=0.0, name='lifetimeValue') # New: Calculated LTV
    ai_notes = Column(Text, name='aiNotes') # New: AI agent insights
    created_at = Column(DateTime(timezone=True), server_default=func.now(), name='createdAt')
...
class Order(Base):
    ...
    shipping_address = Column(Text, name='shippingAddress')
    shipping_method = Column(String, name='shippingMethod')
    payment_method = Column(String, name='paymentMethod')
